...
namespace kiko
{
	...
	inline Matrix33 kiko::Matrix33::CreateRotation(float radians)
	{
		// | c -s 0 |
		// | s  c 0 |
		// | 0  0 1 |
	...
	inline Matrix33 kiko::Matrix33::CreateTranslation(const vec2& translate)
	{
		// | 1 0 x |
		// | 0 1 y |
		// | 0 0 1 |
	...
	inline vec3 kiko::Matrix33::operator*(const vec2& v)
	{
		// | a b c |   | x |
		// | d e f | * | y |
		// | g h i |   | 1 |
		...
		//result.z = rows[2][0] * v.x + rows[2][1] * v.y + rows[2][2];
